...
bool connectafriend(map<ll,User>& users,ll id_in,vector<vector<ll>>& adj){
...
bool removeafriend(map<ll,User>& users,ll id_in,vector<vector<ll>>& adj){
     ...
     if(main==1){
          ...
          if(edit==1){
            ...
            cout<<"Your Credentials are changed"<<endl;
             ...
             bool correct=true;
             while(correct){
               correct=connectafriend(users,id_in,adj);
              ...
              bool correct=true;
              while(correct){
                correct=removeafriend(users,id_in,adj);
              }
          }
          else if(edit==7){
